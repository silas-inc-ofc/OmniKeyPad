...
for i in classic_emoticons_list_of_lists:
    if classic_emoticons_list_of_lists.index(i)> 885 and classic_emoticons_list_of_lists.index(i) <1329:
        CHAR_GROUPS.append((f"E{classic_emoticons_list_of_lists.index(i)+3109}",i))
...
class KeypadApp(tk.Tk):
    ...
    def _build_ui(self):
        ...
        hdr.pack(fill="x")
        tk.Label(hdr, text="⌨  Emojikeypad Extension 12",
                 bg=BG, fg="#66eee7",
