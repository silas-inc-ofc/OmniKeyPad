...
time_base = ['Tp','s','jf','aut','sv','shk','min','mom','hr','d',
             'wk','fn','mth','yr','tyr','gyr','jyr','syr','lyr',
             'dec','cn','mil','ag','gyr','an','glxyr','cdec','eo']
time_units = []
for t in time_base:
    for s in Si_units:
        time_units.append(f'{s}{t}')
CHAR_GROUPS = [
...
class KeypadApp(tk.Tk):
    ...
    def _build_ui(self):
        ...
        hdr.pack(fill="x")
        tk.Label(hdr, text="⌨ UnitKeypad Extension 1",
                 bg=BG, fg="#c8c8ff",
