...
eyes_batches_a = eyes_batches[2]
print(len(eyes_batches))
print(left_cheek_batches)
left_cheek_batches_a = left_cheek_batches[0]
right_cheek_batches_a = right_cheek_batches[0]
...
class KeypadApp(tk.Tk):
    ...
    def _build_ui(self):
        ...
        hdr.pack(fill="x")
        tk.Label(hdr, text="⌨  Emojikeypad Extension 45",
                 bg=BG, fg="#66eee7",
