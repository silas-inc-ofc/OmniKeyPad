...
eyes = list('ᐁᐂᐃᐄᐅᐆᐇᐈᐉᐊᐋᐌᐍᐎᐏᐐᐑᐒᐓᐔᐕᐖᐗᐘᐙᐚᐛᐫᐬᐭᐮᐯᐰᐱᐲᐳᐴᐵᐶᐷᐸᐹᐺᐻᐼᐽᐾᐿᑀᑁᑂᑃᑄᑅᑆᑇᑈᑌᑍᑎᑏᑐᑑᑒᑓᑔᑕᑖᑗᑘᑙᑚᑛᑜᑝᑞᑟᑠᑡᑢᑣᑤᑥᑦᑧᑨᑩᑪᑬᑭᑮᑯᑰᑱᑲᑳᑴᑵᑶᑷᑸᑹᑺᑻᑼᑽᑾᑿᒀᒁᒂᒄᒅᒆᒇᒈᓀᓁᓂᓃᓄᓅᓆᓇᓈᓉᓊᓋᓌᓍᓎᓏᕞᕟᕠᕡᕢᕣᕤᕥᕦᕧᕨᕩᕪᕫᕬᕭᕮᕯᕰᕱᕲᕳᕴᕵᕶᕷᕸᕹᕺᕼᕾᕿᖀᖁᖂᖃᖄᖆᖇᖈᖉ')

mouths = list('⁔‿ϖ∆∇∏∐∩∪∧∨∸∻∾≁∼∿≂∽≍⊌⊍⊎⊓⊔⋀⋁⊳⊲⋂⋃⋒⋓⋄⨃⨆⨄⨅⨿⩂⩅⩃⩀⩂⩅⩄⩁⩇⩈⩋⩎⩑⩔⩗⩉⩌⩏⩒⩕⩘⩊⩍⩐⩓⩖⩙⩚⩝⩛⩟⪦⪧⫏⫐⪤Дд')

left_cheek =list('∈∉≮≤≰≨≦≲≴≪≺⊆≾⊊⊂≼⊄⊈⊏⊑⋠⋞⋜⋢⋦⋨⩽⪁⪇⪍⪅⪃⪉⪙⪗⪝⪕⪛⪡⪬⪯⪪⪷⪽⫃⪵⪻⫁⪹⪿⫅⫉⫇⫹⫷⩻⩹⩿')
RIGHT_CHEEK =list('∋∌≯≥≱≩≧≳≵≫≻⊇≿⊋⊃≽⊅⊉⊐⊒⋡⋟⋝⋣⋧⋩⩾⪂⪈⪎⪆⪄⪊⪚⪘⪞⪖⪜⪢⪭⪰⪫⪸⪾⫄⪶⪼⫂⪺⫀⫆⫊⫈⫺⫸⩼⩺⪀')
eyes_batches = list(batched(eyes,len(eyes)//9))
...
class KeypadApp(tk.Tk):
    ...
    def _build_ui(self):
        ...
        hdr.pack(fill="x")
        tk.Label(hdr, text="⌨  Emojikeypad Extension 575",
                 bg=BG, fg="#66eee7",
