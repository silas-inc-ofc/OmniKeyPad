...
classic_emoticons_list_of_lists = list(batched(emoticons_list,2000))
...
for i in classic_emoticons_list_of_lists:
    if classic_emoticons_list_of_lists.index(i) > 1362 and classic_emoticons_list_of_lists.index(i) < 1805:
        CHAR_GROUPS.append((f"E{classic_emoticons_list_of_lists.index(i)+628}",i))
...
class KeypadApp(tk.Tk):
    ...
    def _build_ui(self):
        ...
        hdr.pack(fill="x")
        tk.Label(hdr, text="⌨  Emojikeypad Extension 7",
                 bg=BG, fg="#66eee7",
