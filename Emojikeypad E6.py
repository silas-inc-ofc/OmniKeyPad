...
for i in classic_emoticons_list_of_lists:
    if classic_emoticons_list_of_lists.index(i) > 919 and classic_emoticons_list_of_lists.index(i) < 1363:
...
class KeypadApp(tk.Tk):
    ...
    def _build_ui(self):
        ...
        hdr.pack(fill="x")
        tk.Label(hdr, text="⌨  Emojikeypad Extension 6",
                 bg=BG, fg="#66eee7",
